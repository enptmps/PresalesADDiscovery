<#
			"EnPointe Messaging Team"	
			Instructions
			Istall RSAT 
			Download this file, rename it to .ps1, and run it in powershell with domain admin rights.

			Date	: 18-aug-2015
			File	: Active_Directory_Information
			Purpose : Gathering Information about Active Directory
